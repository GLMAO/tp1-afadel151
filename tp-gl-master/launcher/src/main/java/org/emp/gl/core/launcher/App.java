...
public class App {
    ...
    public static void main(String[] args) {
        ...
        testDuTimeServiceHorlogeGUI(Service); // remplace par testDuTimeServiceHorloge
    }
    ...
    private static void testDuTimeServiceHorlogeGUI(TimerService Service) {
        HorlogeGUI gui = new HorlogeGUI("horloge 1", Service);
        Service.addTimeChangeListener(gui);
    }
